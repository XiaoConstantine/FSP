...
DATA_INPUT_FILE_1="tradingbook_opening.txt"
DATA_INPUT_FILE_2="tradingbook_closing.txt"

YC_INPUT_FILE="yieldcurve.txt"

echo "passing param: $DATA_INPUT_FILE_1 $DATA_INPUT_FILE_2 $YC_INPUT_FILE executable: $EXECUTABLE" 
echo

#SBB_DEBUG=1; export SBB_DEBUG

echo "======= spawning executable ======="
$EXECUTABLE  $DATA_INPUT_FILE_1 $DATA_INPUT_FILE_2 $YC_INPUT_FILE  3> $ERROR_LOGFILE >&1
