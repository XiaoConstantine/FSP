...
XC_bond_ratings::XC_bond_ratings() 
{
...
const
BOND_RATINGS* 
XC_bond_ratings::get_ratings_record(char* s_and_p_code)
const
{
...
void
XC_bond_ratings::free_list_of_codes()
{
...
char** 
XC_bond_ratings::get_quality_code_namespace_s_and_p(int& count) 
const
{
	count = _table_count;
...
double
XC_bond_ratings::LGD_given_SnP_Fitch(const char* code)
const
{
...
//
// to compile this, add -DTEST_DRIVER on compile line e.g., : "g++ XC_ratings.cc -DTEST_DRIVER"
